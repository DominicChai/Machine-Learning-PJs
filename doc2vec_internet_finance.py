...
import os
import csv
csvFile=open(r"test_bodies_vectors.csv","w+",newline="",encoding='utf-8')#在桌面形成csv文件#
writer=csv.writer(csvFile)
sentences = gensim.models.doc2vec.TaggedLineDocument('test_bodies.txt')#输入文件vivomidcut.txt的格式就是每个doc 对应内容的分词，空格隔开，每个doc是一行#
